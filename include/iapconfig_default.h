...
#define USER_PROG_END_ADDRESS  0x803FFFF
#define USER_PROG_BEGIN_SECTOR FLASH_SECTOR_1
#define USER_PROG_END_SECTOR FLASH_SECTOR_5

#define TEMP_PROG_BEGIN_ADDRESS 0x8040000  
#define TEMP_PROG_END_ADDRESS  0x807FFFF
#define TEMP_PROG_BEGIN_SECTOR FLASH_SECTOR_6
#define TEMP_PROG_END_SECTOR FLASH_SECTOR_7
